...
heroText: Jakin's blog
tagline: WEB后端技术博客，未来的你会感谢现在努力的自己。
# actionText: 立刻进入 →
# actionLink: /web/
...
### 📚Blog
这是一个兼具博客文章、知识管理、文档查找的个人网站，主要内容是Web后端技术。如果你喜欢这个博客&主题欢迎到[GitHub](https://github.com/xugaoyi/vuepress-theme-vdoing)点个Star、获取源码，或者交换[友链](/friends/) ( •̀ ω •́ )✧
